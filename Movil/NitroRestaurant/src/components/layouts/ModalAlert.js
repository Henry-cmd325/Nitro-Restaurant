                    ...
                    <View style={{backgroundColor: 'rgba(245, 245, 244, 0.5)'}} className='flex-1 justify-end items-center'>
                        <TouchableWithoutFeedback>
                            <View className='bg-white p-5 mb-2 rounded-3xl items-center w-full h-2/6 top-5 shadow-2xl shadow-green-800'>
                                ...
                                <Text className='pt-1 text-black text-xl' style={[Fonts.addText]}>{title}</Text>
                                <Divider className='bg-neutral-200 w-11/12' style={[{height:1}]} />
                                <Text className='text-base mt-4' style={[Fonts.cardsText, {color:'#999'}]}>{message}</Text>
                                <View className='flex-row justify-between'>
                                    <Button className='w-2/5 h-2/5 my-8 mx-5 rounded-full items-center justify-center bg-neutral-100' textColor='#404040'  mode="contained" style={[Fonts.buttonTitle]} onPress={close}>REGRESAR</Button>
