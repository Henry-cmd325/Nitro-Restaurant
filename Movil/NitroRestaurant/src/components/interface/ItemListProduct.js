...
const ItemListProduct = ({ content, items, price }) => {
    return (
        <>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical:10,  marginHorizontal: '1%', marginVertical: '5%' }}>
                ...
                <Image style={[{ borderRadius: 10, width: 70, height: 70 }]} source={{uri: 'https://images.pexels.com/photos/7807417/pexels-photo-7807417.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' }} />

                <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                    <Text style={[styles.txtLabel, Fonts.modalText]}>California Roll</Text>
                    <Text style={[styles.txtLabel, Fonts.cardsText]}>crab & cucumber</Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#ececec', borderRadius: 10, marginTop: 10, marginLeft: 10}}>
                        ...
                        <Text style={[Fonts.cardsText, {color: '#67757d', fontSize: 15}]}>1</Text>
                        <TouchableOpacity style={{ paddingHorizontal: 10, paddingVertical: 5}}>
                ...
                <TouchableOpacity style={{ backgroundColor: '#38447E', borderRadius:15, paddingHorizontal:10, paddingVertical:8}}>
                    <Text style={[styles.txtLabels, Fonts.modalText, { color: '#fafafa'}]}>$100.87</Text>
                </TouchableOpacity>
            </View>
        </>
    );
