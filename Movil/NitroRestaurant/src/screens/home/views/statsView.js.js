...
const StatsView = () => {
    ...
    //[88,69.4,56.7,35.1, 67.8]
    const data = { labels: scheduleArray,
        datasets: [ { data: [88,69.4,56.7,35.1, 67.8], color: (opacity = 1) => `rgba(129, 140, 248, ${opacity})`, strokeWidth: 3 } ], };
                            ...
                            <View className='h-20 w-40 bg-slate-200 rounded-2xl my-2'>
                                <View className='flex-row items-center my-auto px-4'>
                                    ...
                                    <View className='flex-col ml-2'>
                                        ...
                                        <Text className='text-gray-700 text-base'>17:00pm</Text>
                                    </View>
                                </View>
                            </View>
                            <View className='h-20 w-40 bg-slate-200 rounded-2xl my-2 ml-7'>
                                <View className='flex-row items-center my-auto px-3'>
                                    ...
                                    <View className='flex-col ml-2'>
                                        ...
                                        <Text className='text-gray-700 text-base'>10min apox.</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
